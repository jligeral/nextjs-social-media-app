    ...
    return (
      <>
        ...
        >
          ...
          />
          <span className={`absolute flex size-12 justify-center inset-0 m-auto items-center bg-black rounded-full bg-opacity-30 text-white transition-colors duration-200 group-hover:bg-opacity-25`}>
            <Camera size={24} />
          </span>
        </button>
        {imageToCrop && (
